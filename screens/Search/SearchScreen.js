  ...
  componentDidMount = () => {
    ...
    const ipCall = async () => {
      try {
        ...
        // );
        //  Eventually, you'll plug in these dynamic options rather than the
        // static dummy IP you're using now.
        //--------------------------------------------
        var userLocation = await axios.get(
        ...
        this.setState({ nearbyBusinesses: bizArray });
...
*/
  ...
  handleSetOverlay = async (business) => {
    ...
    this.setState({
      ...
      imgUri: business.photos[0].photo_reference,
      ...
      <View style={styles.searchContainer}>
        ...
        <TabNavigator tabBarStyle={{}} sceneStyle={{}}>
          ...
          <TabNavigator.Item
            ...
            selectedTitleStyle={{ color: "#3496f0" }}
            renderIcon={() => <Icon name="map" size={px2dp(22)} color="#667" />}
            renderSelectedIcon={() => (
